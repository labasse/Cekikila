...
namespace CekikilaBack.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        public TagsController(SqlDbContext context)
        {
            _context = context;
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        /// <response code="200">Le tag requis a été trouvé</response>
        /// <response code="404">Aucun tag avec cet identifiant trouvé</response>
        [HttpGet("{id}")]
